...
BOT_COMMANDS = [
    ...
    BotCommand(command="station_manage", description="Меню управления станцией"),
    ...
    BotCommand(command="account_menu", description="Меню аккаунта"),
    ...
    BotCommand(command="games", description="Выбрать игру на станции"),
