...
rem Optional. Standard global proxy variables used automatically.
rem set HTTP_PROXY=http://user:pass@127.0.0.1:8080
rem set HTTPS_PROXY=http://user:pass@127.0.0.1:8080

echo module ERRORS install commands:
echo No module named 'telegram' = pip install "python-telegram-bot>=21,<22"
