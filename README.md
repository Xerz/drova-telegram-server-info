...
- `/current` с текущими сессиями, городом клиента и переходом в управление станциями;
- `/sessions` и `/sessions_short` с пагинацией, IP и городом клиента;
- `/station_manage` для публикации, полного доступа, обновлений, игр и описания станции;
